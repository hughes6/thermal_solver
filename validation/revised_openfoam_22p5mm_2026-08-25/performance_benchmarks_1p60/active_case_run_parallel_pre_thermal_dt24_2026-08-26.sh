...
airflow_refresh_interval="${4:-2400}"
warm_start_maximum_time_step="${THERMAL_WARM_START_MAX_DT:-0.00050000000000000001}"
...
summary "run_start mode=$mode processes=$processes requestedEnd=$requested_end airflowRefreshInterval=$airflow_refresh_interval warmStartMaxDt=$warm_start_maximum_time_step"
...
if [[ "$reuse_decomposition" == true ]]; then
    ...
    if [[ -d "$case_dir/processor0" ]]; then
        ...
        "$foam_launcher" foamDictionary -precision 17 "$case_dir/system/controlDict" -entry deltaT -set 0.10000000000000001
        "$foam_launcher" foamDictionary -precision 17 "$case_dir/system/controlDict" -entry writeInterval -set 300
...
run_fan_ramp()
{
    ...
    for step in $(seq 1 5); do
        ...
        ramp_cap=$(awk -v flow_max="0.00050000000000000001" -v co="5" 'BEGIN { scale=(co<2?co/2:1); print flow_max*scale }')
        ...
        "$foam_launcher" foamDictionary -precision 17 "$case_dir/system/controlDict" -entry maxCo -set 5
...
if [[ "$mode" == "--multirate" ]]; then
    ...
    boundary_flow_names=("Eaton_SU3000RTXLCD2UTAA_UPS_Front_left_intake" "Eaton_SU3000RTXLCD2UTAA_UPS_Front_intake" "Dell_PowerEdge_R470_1U_Front_intake" "Keysight_N5766A_PS_Front_intake" "Keysight_N6701C_PS_Front_intake" "Trenton_3U_BAM_Front_intake" "Trenton_3U_BAM_Front_fan_1" "Trenton_3U_BAM_Front_fan_2" "Trenton_3U_BAM_Front_fan_3" "Trenton_3U_BAM_Front_fan_4" "Trenton_3U_BAM_Front_fan_5" "Thruster_Load_Box_2U_Front_intake_1" "Thruster_Load_Box_2U_Front_intake_2" "Cisco_9300_Network_Switch_Front_intake" "Fan_1" "Fan_2" "Fan_3" "Fan_4" "Fan_5" "Fan_6" "Fan_7" "Fan_8" "Fan_9" "Vent_main_2U_74__perforation" )
    declare -A boundary_flow_lookup=()
    for name in "${boundary_flow_names[@]}"; do
        boundary_flow_lookup["$name"]=1
    done
    tracked_flow_names=("Eaton_SU3000RTXLCD2UTAA_UPS_Front_left_intake" "Eaton_SU3000RTXLCD2UTAA_UPS_Front_intake" "Dell_PowerEdge_R470_1U_Front_intake" "Keysight_N5766A_PS_Front_intake" "Keysight_N6701C_PS_Front_intake" "Trenton_3U_BAM_Front_intake" "Trenton_3U_BAM_Front_fan_1" "Trenton_3U_BAM_Front_fan_2" "Trenton_3U_BAM_Front_fan_3" "Trenton_3U_BAM_Front_fan_4" "Trenton_3U_BAM_Front_fan_5" "Thruster_Load_Box_2U_Front_intake_1" "Thruster_Load_Box_2U_Front_intake_2" "Cisco_9300_Network_Switch_Front_intake" "Fan_1" "Fan_2" "Fan_3" "Fan_4" "Fan_5" "Fan_6" "Fan_7" "Fan_8" "Fan_9" "Vent_main_2U_74__perforation" )
    internal_fan_names=("internal_Rear_exhaust_fan_0" "internal_Cooling_fan_1_2" "internal_Cooling_fan_2_3" "internal_Cooling_fan_3_4" "internal_Cooling_fan_4_5" "internal_Cooling_fan_5_6" "internal_Cooling_fan_6_7" "internal_Front_fan_1_11" "internal_Front_fan_2_12" "internal_Front_fan_3_13" "internal_PS_Exhaust_Fan_14" "internal_Module_1_fan_15" "internal_Module_2_fan_16" "internal_Module_3_fan_17" "internal_Module_4_fan_18" "internal_Front_fan_1_22" "internal_Front_fan_2_23" "internal_Front_fan_3_24" "internal_PS_Exhaust_Fan_25" "internal_Module_1_fan_26" "internal_Module_2_fan_27" "internal_Module_3_fan_28" "internal_Module_4_fan_29" "internal_Rear_exhaust_32" "internal_Exhaust_fan_1_33" "internal_Exhaust_fan_2_34" "internal_Exhaust_fan_1_37" "internal_Exhaust_fan_2_38" "internal_Exhaust_fan_3_39" "internal_Power_supply_exhaust_fan_40" "internal_Bottom_fan_1_49" "internal_Bottom_fan_2_50" "internal_Power_Supply_fan_51" )
    stability_flow_names=("Eaton_SU3000RTXLCD2UTAA_UPS_Front_left_intake" "Eaton_SU3000RTXLCD2UTAA_UPS_Front_intake" "Dell_PowerEdge_R470_1U_Front_intake" "Keysight_N5766A_PS_Front_intake" "Keysight_N6701C_PS_Front_intake" "Trenton_3U_BAM_Front_intake" "Trenton_3U_BAM_Front_fan_1" "Trenton_3U_BAM_Front_fan_2" "Trenton_3U_BAM_Front_fan_3" "Trenton_3U_BAM_Front_fan_4" "Trenton_3U_BAM_Front_fan_5" "Thruster_Load_Box_2U_Front_intake_1" "Thruster_Load_Box_2U_Front_intake_2" "Cisco_9300_Network_Switch_Front_intake" "Fan_1" "Fan_2" "Fan_3" "Fan_4" "Fan_5" "Fan_6" "Fan_7" "Fan_8" "Fan_9" "Vent_main_2U_74__perforation" "internal_Rear_exhaust_fan_0" "internal_Cooling_fan_1_2" "internal_Cooling_fan_2_3" "internal_Cooling_fan_3_4" "internal_Cooling_fan_4_5" "internal_Cooling_fan_5_6" "internal_Cooling_fan_6_7" "internal_Front_fan_1_11" "internal_Front_fan_2_12" "internal_Front_fan_3_13" "internal_PS_Exhaust_Fan_14" "internal_Module_1_fan_15" "internal_Module_2_fan_16" "internal_Module_3_fan_17" "internal_Module_4_fan_18" "internal_Front_fan_1_22" "internal_Front_fan_2_23" "internal_Front_fan_3_24" "internal_PS_Exhaust_Fan_25" "internal_Module_1_fan_26" "internal_Module_2_fan_27" "internal_Module_3_fan_28" "internal_Module_4_fan_29" "internal_Rear_exhaust_32" "internal_Exhaust_fan_1_33" "internal_Exhaust_fan_2_34" "internal_Exhaust_fan_1_37" "internal_Exhaust_fan_2_38" "internal_Exhaust_fan_3_39" "internal_Power_supply_exhaust_fan_40" "internal_Bottom_fan_1_49" "internal_Bottom_fan_2_50" "internal_Power_Supply_fan_51" )
    component_region_names=("Eaton_SU3000RTXLCD2UTAA_UPS_0" "Dell_PowerEdge_R470_1U_1" "Keysight_N5766A_PS_2" "Keysight_N6701C_PS_3" "Trenton_3U_BAM_4" "Tripp_Lite_B020_U08_19_IP_KVM_5" "region_3U_storage_Shelf_6" "Thruster_Load_Box_2U_7" "Cisco_9300_Network_Switch_8" "Eaton_PDUMNH30_PDU_9" "Meanwell_EDR_120_24_10" "Meanwell_EDR_120_24_11" "NI_PXIe_784782_01_Chassis_12" )
    fan_direction_rules=("Trenton_3U_BAM_Front_fan_1:-1" "Trenton_3U_BAM_Front_fan_2:-1" "Trenton_3U_BAM_Front_fan_3:-1" "Trenton_3U_BAM_Front_fan_4:-1" "Trenton_3U_BAM_Front_fan_5:-1" "Fan_1:1" "Fan_2:1" "Fan_3:1" "Fan_4:1" "Fan_5:1" "Fan_6:1" "Fan_7:1" "Fan_8:1" "Fan_9:1" )
    ...
    validate_accepted_airflow_drift()
    {
        ...
        if ! awk -v value="$accepted_airflow_relative_rms" -v limit="0.029999999999999999" 'BEGIN { exit !(value<=limit) }'; then
            record_accepted_airflow_reference || return 1
            return 1
        fi
        return 0
    ...
    airflow_metrics_converged()
    {
        ...
        local imbalance stable=1 directions_ok=1 maximum_change=0 maximum_change_name=none change boundary_flow_floor=0 flow_floor=0 comparison_value comparison_reference airflow_state_tmp
        latest_one_way_boundary_mass_flow=""
        ...
        boundary_flow_floor=$(awk -v s="$sum_abs" -v f="0.001" 'BEGIN { print 0.5*s*f }')
        ...
        air_exchange_time=$(awk -v volume="1.061551306555625" -v rho="0.98329999999999995" -v s="$sum_abs" 'BEGIN { one_way=0.5*s; print (one_way>1e-12?volume*rho/one_way:1e30) }')
        ...
        if ! awk -v v="$maximum_change" -v limit="0.01" 'BEGIN { exit !(v<=limit) }'; then stable=0; fi
        if [[ -z "$latest_velocity_relative_rms" || -z "$previous_velocity_relative_rms" ]] || ! awk -v v="$latest_velocity_relative_rms" -v limit="0.029999999999999999" 'BEGIN { exit !(v<=limit) }' || ! awk -v v="$previous_velocity_relative_rms" -v limit="0.029999999999999999" 'BEGIN { exit !(v<=limit) }'; then stable=0; fi
        echo "Airflow refresh metrics: imbalance=$imbalance, maxFlowChange=$maximum_change, maxFlowDevice=$maximum_change_name, boundaryFlowFloor=$boundary_flow_floor, directionsOK=$directions_ok, velocityRelativeRms=${latest_velocity_relative_rms:-unavailable}, previousVelocityRelativeRms=${previous_velocity_relative_rms:-unavailable}, estimatedAirExchangeTime=$air_exchange_time s"
    ...
    thermal_metrics_converged()
    {
        ...
        if ! awk -v t="$checkpoint_time" -v minimum="2400" 'BEGIN { scale=(minimum<0?-minimum:minimum); if(scale<1)scale=1; tolerance=1e-9*scale; exit !(t>=minimum-tolerance) }'; then return 1; fi
        if ! awk -v v="$scaled_delta" -v limit="0.25" 'BEGIN { exit !(v<=limit) }'; then return 1; fi
        if ! awk -v v="$scaled_average_delta" -v limit="0.10000000000000001" 'BEGIN { exit !(v<=limit) }'; then return 1; fi
        return 0
    }
    stage()
    {
        local thermal_only="$1" target="$2" max_co="$3" max_dt="$4" label="$5" live_dt_cap="$6"
        local interval actual_time saved_time canonical_time restart_dt saved_time_file rank stage_steps stage_dt stage_max_dt stage_write_control stage_write_interval checkpoint_steps field source_field target_field courant_output observed_co courant_safe_dt airflow_hard_cap postflight_output postflight_co spatial_output spatial_status velocity_rms_delta velocity_rms_reference stage_wall_start stage_wall_end stage_wall_seconds stage_velocity_reference stage_velocity_reference_tmp
        ...
        if [[ "$thermal_only" == "true" ]]; then
            ...
            echo "Thermal-only maxCo=$max_co is diagnostic; the fully implicit frozen-flow energy timestep is limited by maxDeltaT=$max_dt s."
            stage_max_dt="$max_dt"
        ...
        echo "Stage wall time: label=$label, thermalOnly=$thermal_only, start=$current, target=$actual_time, seconds=$stage_wall_seconds"
    ...
    adaptive_airflow_refresh()
    {
        ...
        if [[ -f "$refresh_pending_marker" ]]; then
            ...
            if [[ "$pending_refresh_start" =~ ^[0-9]+([.][0-9]+)?([eE][-+]?[0-9]+)?$ ]] && awk -v start="$pending_refresh_start" -v now="$current" 'BEGIN { scale=(now<0?-now:now); if(scale<1)scale=1; tolerance=1e-9*scale; exit !(start<=now+tolerance) }'; then
                if ! awk -v start="$pending_refresh_start" -v now="$current" -v maximum="20" 'BEGIN { scale=(now<0?-now:now); if(scale<1)scale=1; tolerance=1e-9*scale; exit !(now<=start+maximum+tolerance) }'; then
...
' "$refresh_start" > "$refresh_pending_marker"
        ...
        while true; do
            refresh_target=$(awk -v a="$current" -v d="0.01" -v start="$refresh_start" -v maximum="20" -v end="$requested_end" 'BEGIN { x=a+d; limit=start+maximum; if(x>limit)x=limit; if(x>end)x=end; printf "%.17g", x }')
            stage false "$refresh_target" 2 1 "Adaptive airflow refresh" 0.001
            refresh_elapsed=$(awk -v a="$current" -v b="$refresh_start" 'BEGIN { print a-b }')
            if awk -v a="$refresh_elapsed" -v b="0.01" 'BEGIN { exit !(a>=b) }'; then
    ...
    adaptive_initial_airflow()
    {
        ...
        if [[ -s "$initial_pending_marker" ]]; then
            ...
            if [[ "$pending_initial_start" =~ ^[0-9]+([.][0-9]+)?([eE][-+]?[0-9]+)?$ ]] && awk -v start="$pending_initial_start" -v now="$current" -v maximum="20" 'BEGIN { scale=(now<0?-now:now); if(scale<1)scale=1; tolerance=1e-9*scale; exit !(start<=now+tolerance && now<=start+maximum+tolerance) }'; then
        ...
        initial_limit=$(awk -v start="$initial_start" -v maximum="20" -v end="$requested_end" 'BEGIN { limit=start+maximum; print (limit<end?limit:end) }')
        if [[ ! -f "$mapped_state_marker" ]]; then
            eligibility_target=$(awk -v start="$initial_start" -v minimum="0.29999999999999999" -v interval="0.01" -v limit="$initial_limit" 'BEGIN { lead=minimum-2*interval; if(lead<0)lead=0; x=start+lead; if(x>limit)x=limit; printf "%.17g", x }')
        fi
        ...
        while awk -v a="$current" -v b="$initial_limit" 'BEGIN { s=(b<0?-b:b); if(s<1)s=1; tol=1e-9*s; exit !(a<b-tol) }'; do
            ...
            stage false "$initial_target" 5 1 "Adaptive initial airflow" 0.00050000000000000001
            initial_elapsed=$(awk -v a="$current" -v b="$initial_start" 'BEGIN { print a-b }')
            minimum_observation="0.29999999999999999"
            if [[ -f "$mapped_state_marker" ]]; then
        ...
        if ! awk -v a="$current" -v b="$requested_end" 'BEGIN { s=(b<0?-b:b); if(s<1)s=1; tol=1e-9*s; exit !(a>=b-tol) }'; then
            echo "Initial airflow failed to converge before the airflow_warmup_time safety limit of 20 s." >&2
            return 3
        fi
    }
    ...
    while awk -v a="$current" -v b="$requested_end" 'BEGIN { s=(b<0?-b:b); if(s<1)s=1; tol=1e-9*s; exit !(a<b-tol) }'; do
        ...
        stage true "$frozen_target" 1000 20 "Implicit thermal-only stage (airflow held)" 1
        thermal_candidate=0
        airflow_validated=0
        ...
        if ! awk -v a="$current" -v b="$requested_end" 'BEGIN { s=(b<0?-b:b); if(s<1)s=1; tol=1e-9*s; exit !(a<b-tol) }'; then
            ...
            requested_end=$(awk -v a="$current" -v d="20" 'BEGIN { printf "%.17g", a+d }')
...
"$foam_launcher" foamDictionary -precision 17 "$case_dir/system/fluid/fvSolution" -entry PIMPLE/momentumPredictor -set true
"$foam_launcher" foamDictionary -precision 17 "$case_dir/system/controlDict" -entry maxCo -set 5
"$foam_launcher" foamDictionary -precision 17 "$case_dir/system/controlDict" -entry maxDeltaT -set 1
"$foam_launcher" foamDictionary -precision 17 "$case_dir/system/controlDict" -entry adjustTimeStep -set true
if [[ "$mode" == "--warm-start" ]]; then
    ...
    "$foam_launcher" foamDictionary -precision 17 "$case_dir/system/controlDict" -entry endTime -set 30
    "$foam_launcher" foamDictionary -precision 17 "$case_dir/system/controlDict" -entry writeControl -set adjustableRunTime
    "$foam_launcher" foamDictionary -precision 17 "$case_dir/system/controlDict" -entry writeInterval -set 300
